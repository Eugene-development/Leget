...
const navigation = [
  ...
  },
  {
    title: 'Услуги',
    links: [
      { title: 'Быстрый сайт', href: '/about' },
      { title: 'Администрирование', href: '/process' },
  ...
  return (
    <form className="max-w-sm">
      ...
      <p className="mt-4 text-sm text-neutral-700">
        Следите за выходом статей и новостей от нашей компании Leget
      </p>
      ...
      <FadeIn>
        ...
        <div className="mb-20 mt-24 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          ...
          <p className="text-sm text-neutral-700">
            © IT Company LEGET. {new Date().getFullYear()}
          </p>
        </div>
      </FadeIn>
    </Container>
